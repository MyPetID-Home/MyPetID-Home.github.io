      ...
      <div className="dashboardGrid supabaseGrid">
        ...
        <article className="panel wide">
          ...
          <div className="grid2">
            ...
            <label>Species<select value={petDraft.species} onChange={(event) => setPetDraft({ ...petDraft, species: event.target.value })}><option value="dog">Dog</option><option value="cat">Cat</option><option value="bird">Bird</option><option value="rabbit">Rabbit</option><option value="reptile">Reptile</option><option value="other">Other</option></select></label>
            <label>Breed<select value={petDraft.breed} onChange={(event) => setPetDraft({ ...petDraft, breed: event.target.value })}><option>Good boy mix</option><option>Labrador Retriever</option><option>Golden Retriever</option><option>German Shepherd</option><option>Poodle</option><option>French Bulldog</option><option>Bulldog</option><option>Beagle</option><option>Rottweiler</option><option>Dachshund</option><option>Australian Shepherd</option><option>Border Collie</option><option>Pit Bull / bully mix</option><option>Chihuahua</option><option>Boxer</option><option>Great Dane</option><option>Husky</option><option>Mastiff</option><option>Corgi</option><option>Cat - Domestic Shorthair</option><option>Cat - Domestic Longhair</option><option>Other / custom</option></select></label>
