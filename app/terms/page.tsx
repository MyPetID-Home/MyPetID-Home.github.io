...
<p>Users must keep login credentials secure and should report suspected account compromise. Password resets, email changes, and future verification workflows may require email confirmation, PIN verification, or other security checks.</p>

<h2>6. SMS, email, and verification</h2>

<p>MyPetID may use email and, if configured with an approved provider, SMS or phone-based verification to help confirm signups, password changes, email changes, and account recovery requests. Automated SMS from the listed business phone requires an approved messaging provider or API integration before it can be used in production.</p>
